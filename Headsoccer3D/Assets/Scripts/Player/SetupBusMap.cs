...
public class SetupBusMap : MonoBehaviour
{
    ...
    public void SetupBusGame(List<GameObject> players, List<PlayerInputController> inputControllers)
    {
        ...
        if (players.Count == 2)
        {
            inputControllers[0].SetControlledObject(flippers[0].GetComponentInChildren<PinballFlipper>(), false);
            inputControllers[0].SetControlledObject(flippers[1].GetComponentInChildren<PinballFlipper>(), false);
            ...
            inputControllers[1].SetControlledObject(flippers[2].GetComponentInChildren<PinballFlipper>(), false);
            inputControllers[1].SetControlledObject(flippers[3].GetComponentInChildren<PinballFlipper>(), false);
        ...
        else if (players.Count == 4)
        {
            ...
            inputControllers[1].SetControlledObject(flippers[1].GetComponentInChildren<PinballFlipper>(), false);
            players[1].GetComponent<PlayerGroundMarker>().controlledFlippers.Add(flippers[1]);

            inputControllers[2].SetControlledObject(flippers[2].GetComponentInChildren<PinballFlipper>(), false);
            players[2].GetComponent<PlayerGroundMarker>().controlledFlippers.Add(flippers[2]);

            inputControllers[3].SetControlledObject(flippers[3].GetComponentInChildren<PinballFlipper>(), false);
