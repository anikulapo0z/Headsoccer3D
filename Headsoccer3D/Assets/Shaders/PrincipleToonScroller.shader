Shader "Saphead Studios/Principle Toon Scroller"
{
    Properties
	{
		//Base
        ...
        [ShowAsVector2] _ScrollDirectionBase("Scroll Direction", Vector) = (0, 0, 0, 0)
        ...
        [ShowAsVector2] _ScrollDirectionShadows("Scroll Direction", Vector) = (0, 0, 0, 0)
        ...
        [ShowAsVector2] _ScrollDirectionHalftone("Scroll Direction", Vector) = (0, 0, 0, 0)
    ...
    SubShader
    {
		...
		Pass
		{
            ...
            half2 _ScrollDirectionBase;
            half2 _ScrollDirectionShadows;
            half2 _ScrollDirectionHalftone;
			...
			half4 PrincipleToonFragmentLit(Varyings i) : SV_Target
			{
                ...
                #else
                    baseTexture = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv + (_ScrollDirectionBase * _Time.y));
                ...
                //---------------------------Halftone
                    ...
                    #if _HALFTONEMASK
                        halftoneMask = SAMPLE_TEXTURE2D(_HalftoneMaskTex, sampler_HalftoneMaskTex, i.uv + (_ScrollDirectionHalftone * _Time.y));
                ...
                //------------------------------Shadow and its Pattern
				    ...
				    float2 shadowUV = (i.uv * _ShadowFrequency) + (_ScrollDirectionShadows * _Time.y);
